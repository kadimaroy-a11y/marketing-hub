...
def _build_events_section(brand: dict) -> str:
    ...
    return (
        "\n\n═══════════════════════════════════════\n"
        " 📅 אירועים פעילים החודש — חובה לשלב!\n"
        "═══════════════════════════════════════\n\n"
        "⚠️ חוק ברזל — אירועים:\n"
        "האירועים הבאים מסומנים כפעילים לחודש הנוכחי.\n"
        "חובה לשלב לפחות אחד מהם בתוכן שתיצור — בכיתוב הראשי, בסטורי, או בכיוון הויזואלי.\n"
        "אל תתעלם מהם. אם יש כמה — בחר את הרלוונטי ביותר לבריף.\n\n"
        + lines
    )
