...
| **דף מוצר** | `amazon.co.il/product/...` | מחיר, זמינות, ביקורות |""",
        ...
        "cl_perf_label":            "📊 איך הפוסט ביצע?",
        "cl_perf_note_label":       "הערת ביצועים",
        "cl_perf_note_placeholder": 'לדוגמה: 500 לייקים, 20 שיתופים, הגיע ל-10K צפיות...',
        "cl_perf_save_btn":         "💾 שמור דירוג",
        "cl_perf_saved":            "✅ דירוג נשמר!",
        "cl_perf_add_to_kb":        "➕ הוסף ל-{target}",
        "cl_perf_added_to_kb":      "✅ נוסף לבסיס הידע!",
        "cl_perf_options":          {"amazing": "🌟 מדהים", "good": "👍 טוב", "okay": "🤷 בסדר", "poor": "👎 חלש", "not_used": "⏸️ לא פורסם"},
...
| **Product Page** | `amazon.co.il/product/...` | Price, availability, reviews |""",
        ...
        "cl_perf_label":            "📊 How did this post perform?",
        "cl_perf_note_label":       "Performance note",
        "cl_perf_note_placeholder": "E.g.: 500 likes, 20 shares, reached 10K views...",
        "cl_perf_save_btn":         "💾 Save Rating",
        "cl_perf_saved":            "✅ Rating saved!",
        "cl_perf_add_to_kb":        "➕ Add to {target}",
        "cl_perf_added_to_kb":      "✅ Added to knowledge base!",
        "cl_perf_options":          {"amazing": "🌟 Amazing", "good": "👍 Good", "okay": "🤷 Okay", "poor": "👎 Poor", "not_used": "⏸️ Not posted"},
